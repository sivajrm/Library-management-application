...
import com.app.library.OAuth.User.ApplicationUser;
import com.app.library.OAuth.User.ApplicationUserRepository;
import com.app.library.OAuth.User.UserService;
...
@Service
public class MongoUserDetailsService implements UserDetailsService, UserService {
